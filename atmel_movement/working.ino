...
//    {
    ...
    //}
    counter_concrete= counter_concrete+1;
  }
  else
  {
    digitalWrite(ledPin,HIGH);
    counter_grass= counter_grass+1;
  } 
  sum = counter_concrete + counter_grass;
//  Serial.print(sum);
  
  if(sum == 5)
  {
    Serial.print("grass ");Serial.print("grass ");Serial.print("grass ");Serial.print("grass ");Serial.print("grass ");Serial.print("grass ");
    
    if(counter_grass>counter_concrete)
    {
      digitalWrite(cluster, HIGH);
      Serial.print("It is Grass!!!!!!! ");
    }
    else
    {
       digitalWrite(cluster,LOW);
        
       Serial.print("It is Concrete!!!!!!! ");
    }
    counter_concrete = 0;
    counter_grass = 0;
    sum = 0;
